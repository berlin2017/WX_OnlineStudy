import EmojiObj from '../../myutils/emojimap.js'
...
Component({
   ...
   */
  data: {
    localAlbumImages: ['/pages/Resources/album-emoji.png', '/pages/Resources/album-ajtd.png', '/pages/Resources/album-xxy.png', '/pages/Resources/album-lt.png'],
    albumArr: [],
    currentAlbum: 'emoji',
    emojiList: {},
