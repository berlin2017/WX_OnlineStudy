import { generateFingerGuessImageFile, generateBigEmojiImageFile, generateRichTextNode, generateImageNode, calcTimeHeader } from '../../myutils/util.js'
import { deepClone, clickLogoJumpToCard } from '../../myutils/util.js'
import * as iconBase64Map from '../../myutils/imageBase64.js'

import { pushLog, checkStringLength } from '../../myutils/util.js'
import { iconLogo } from '../../myutils/imageBase64.js'
import IMEventHandler from '../../myutils/imeventhandler.js'
import MD5 from '../../vendors/md5.js'
import { post, validStringType } from '../../myutils/util.js'

var app = getApp()
Page({
  data: {
    title:'聊天室',
    defaultUserLogo: '../Resources/default-icon.png',
  ...
  onLoad: function (options) {
    ...
    app.userInfoReadyCallback = res => {
      var account = 'ah' + res.userInfo.nickName;
      var nickname = res.userInfo.nickName;
      this.registerSubmit(account, nickname);
        ...
        account: chatTo,
          ...
          if (err) {
            ...
            self.setData({
              ...
              chatToLogo: app.globalData.loginUser['avatar'] || self.data.defaultUserLogo,
            })
            // wx.showToast({
            //   title: err.message,
            //   icon: 'none',
  ...
  * 单击注册，登录表单提交
  */
  registerSubmit: function (name, nick) {
    let errorMessage = '';
    // username = this.data.account,
    // nickname = this.data.nickname,
    let password = 'ah123456'
    let self = this
