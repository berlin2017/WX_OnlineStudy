...
<html>
  ...
  <body>
    <div class="wrapper">
      ...
      <h1 id="standard-output-appender">Standard Output Appender</h1>

<p>This appender writes all log events to the standard output stream. It is the default appender for log4js.</p>

<h1 id="configuration">Configuration</h1>

<ul>
  <li><code class="highlighter-rouge">type</code> - <code class="highlighter-rouge">stdout</code></li>
...
<div class="language-javascript highlighter-rouge"><pre class="highlight"><code><span class="nx">log4js</span><span class="p">.</span><span class="nx">configure</span><span class="p">({</span>
  <span class="na">appenders</span><span class="p">:</span> <span class="p">{</span> <span class="s1">'out'</span><span class="p">:</span> <span class="p">{</span> <span class="na">type</span><span class="p">:</span> <span class="s1">'stdout'</span> <span class="p">}</span> <span class="p">},</span>
