...
<html>
  ...
  <body>
    <div class="wrapper">
      ...
      <h1 id="logfaces-appender-udp">logFaces Appender (UDP)</h1>

<p>The logFaces appenders send JSON formatted log events to <a href="http://www.moonlit-software.com">logFaces</a> receivers. This appender uses UDP to send the events (there is another logFaces appender that uses <a href="/logFaces-HTTP.html">HTTP</a>). It uses the node.js core UDP support, so you do not need to include any other dependencies.</p>

<h2 id="configuration">Configuration</h2>

<ul>
  <li><code class="highlighter-rouge">type</code> - <code class="highlighter-rouge">logFaces-UDP</code></li>
  <li><code class="highlighter-rouge">remoteHost</code> - <code class="highlighter-rouge">string</code> (optional, defaults to ‘127.0.0.1’)- hostname or IP address of the logFaces receiver</li>
  <li><code class="highlighter-rouge">port</code> - <code class="highlighter-rouge">integer</code> (optional, defaults to 55201) - port the logFaces receiver is listening on</li>
...
<div class="language-javascript highlighter-rouge"><pre class="highlight"><code><span class="nx">log4js</span><span class="p">.</span><span class="nx">configure</span><span class="p">({</span>
  <span class="na">appenders</span><span class="p">:</span> <span class="p">{</span>
    <span class="na">logfaces</span><span class="p">:</span> <span class="p">{</span> <span class="na">type</span><span class="p">:</span> <span class="s1">'logFaces-UDP'</span> <span class="p">}</span>
  <span class="p">},</span>
...
<p>This example will result in two log events being sent via UDP to <code class="highlighter-rouge">127.0.0.1:55201</code>. Both events will have a <code class="highlighter-rouge">p_requestId</code> property with a value of <code class="highlighter-rouge">123</code>.</p>
